	...
	<div class='GuangdongTheFigure'> 
		...
		<div class='content'>
			<div class="verification">
				<div>paasId:<el-input v-model="paasId"  placeholder="paasId" class="input"></el-input></div>
				<div>paasToken:<el-input  v-model="paasToken" placeholder="paasToken" class="input"></el-input></div>
			</div>
			<div>
			...
			<div>
				{{serverTipName}}<el-input v-model="geoCodingUrl"  placeholder="请输入地址" class="input"></el-input>
				</el-select>
			...
			<div class="toLoad" @click="loadLayers"><div>加载至地图</div></div>
		</div>
...
<style  lang="scss">
	.GuangdongTheFigure{
		.input{width:60%;}
		.content{width:600px;min-height:600px;border:1px solid red;margin: auto;margin-top: 10%;
			.verification{display: flex;justify-content:space-between;}
			.serviceTableUrl{width:100%;
				div{
					position: relative;
					span{display: inline-block;width:100%;}
					button{position: absolute;right: 10%;top:5px;}
				}
			}
			.toLoad{width:100%;height:100px;line-height: 50px;display: flex;
				div{text-align: center;background-color: greenyellow;width:130px;margin: auto;}
			}
		}
	}
</style>
