      ...
      addWmtsLayers: function () {
        ...
        console.log(this.map,'that.map')
         console.log(this.map.addSource,'that.map')
          ...
          //需要传参数
      		getproxyHandler("paasId=zwdsj_jmszsj_zhcs&paasToken=YGr1V9UzHRdRf11Eqea2p30LnL7CQ6mp&url="+wmtsConfig.url+"?service=wmts&REQUEST=GetCapabilities").then(res=>{
...
<style lang="scss" >
    ...
    // }
    .gmap{width:1000px;height:1000px;border: 1px solid red;
		
	}
    .gudMap{
      .input{width:60%;}
      .content{width:700px;height:600px;border: 1px solid red;position: absolute;top: 0;right: 0;}
    }
</style>
