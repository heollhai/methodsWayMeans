<template>
	<div style="height: calc(100% - 130px);">
		...
		<!-- 
		 ...
		 layout  			页面分页条需要展示哪些
		 -->
		<el-pagination background @current-change="current_change" @size-change="handleSizeChange" :current-page="currentPage"
		 :page-sizes="[4, 8, 30, 40]" :page-size="pagesize" layout="total, sizes, prev, pager, next, jumper" :total="tableData.length">
		</el-pagination>
	</div>
</template>
<script>
