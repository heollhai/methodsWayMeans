<template>
	<!-- 
	 ...
	 -->
    <div>
		地址：<input v-model="keyword"><el-button >aaaa</el-button>
        <baidu-map class="map" :center="map.center" :zoom="map.zoom" @ready="handler" @click="getPoint">
			<!-- 地图搜索功能，绑定上面的input，
			...
			<!-- //添加地图类型  地图 +2D图，混合图 -->
			 <bm-map-type  :map-types="['BMAP_NORMAL_MAP', 'BMAP_HYBRID_MAP']" :offset="{width:100,height:20}" anchor="BMAP_ANCHOR_TOP_LEFT"></bm-map-type>
			<!-- 左上角的移动和放大缩小 -->
			<bm-navigation anchor="BMAP_ANCHOR_TOP_LEFT" style="top:100px" :offset="{width:20,height:20}"></bm-navigation>
			<!-- 获取用户定位，在右下角 -->
			<bm-geolocation anchor="BMAP_ANCHOR_BOTTOM_RIGHT" :showAddressBar="true" :autoLocation="true"></bm-geolocation>
			<!-- 城市列表搜索 -->
			 <bm-city-list anchor="BMAP_ANCHOR_TOP_RIGHT" :offset="{width:20,height:20}"></bm-city-list>
			<!--比例尺控件-->
			<bm-scale anchor="BMAP_ANCHOR_TOP_LEFT"  :offset="{width:220,height:20}"></bm-scale>
