<template>
	<div style="height: 2000px;" id="box">
		...
		<div><el-button @click="instruction">自定义指令</el-button>自定义指令里面的内容: {{focusValue}}</div>
		<div>
...
<script>
	...
	export default {
		name: 'public',
		components:{customInstruction,component1,component2},
		data() {
			return {
				isFixed:false,
...
<style lang="scss" scoped="scoped">
	...
	.colorRed,.color{
		width: 100px;height: 100px;background: red;color:#fff;
